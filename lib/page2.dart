            ...
            Container(
              ...
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 8),
                  Text(
                    'Im 12th grade student at SMK WIKRAMA BOGOR, specializing in Backend and Data Science, I work with Javascript, Typescript, React JS, PHP, Python and Jupyter.',
              ...
              child: Column(
                ...
                children: const [
                  ...
                  Text(
                        ...
                        'SMK Wikrama Bogor\n\n'
                        '2019 - 2021\n'
                        'SMP Negeri Cisarua 01\n\n'
                        '2013 - 2019\n'
                        'SD Negeri Cisarua 01',
                    style: TextStyle(color: Colors.white),
                  ),
                  SizedBox(height: 20),
                  Text(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  skillCard('Laravel', 0.8),
                  const SizedBox(height: 20),
                  skillCard('React JS', 0.7),
                  const SizedBox(height: 20),
                  skillCard('JavaScript', 0.6),
                  const SizedBox(height: 20),
                  skillCard('Python', 0.85),
                  const SizedBox(height: 20),
                  skillCard('Jupyter', 0.8),
                ],
              ),
            ),
          ],
